...
import com.empresa.estructuracion.batch.service.CsvWriterService;
...
public class CsvGenerationService implements CsvWriterService {
    ...
    public byte[] rowBytes(StagingRecord record, String decryptedDataMap, MessageDigest digest) {
        ...
        String line = CsvUtils.line(List.of(
                ...
                compactListaTables,
                record.documentType(),
                java.util.HexFormat.of().formatHex(record.uniqueHash())));
